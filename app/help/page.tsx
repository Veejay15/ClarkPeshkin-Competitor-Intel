      ...
      <div className="space-y-6">
            ...
            items={[
              {
                ...
                desc: 'Click "Add competitor", enter the firm name and domain (e.g. cimino-law.com). The tool auto-detects their sitemap.',
              },
              {
                term: 'Pause Tracking',
        ...
        >
          ...
          <p className="text-sm text-slate-600">
            ...
            domain (e.g. <code>cimino-law-com</code>). You can see all IDs
            on the{' '}
          ...
          <DefList
            items={[
              ...
              },
              {
                ...
                desc: 'Use {competitor-id}-{type}.csv format (e.g. cimino-law-com-backlinks.csv) so the AI knows which competitor each file belongs to.',
              },
            ]}
          />
          <p className="text-sm text-slate-600">
